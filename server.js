...
// ========================
// CORS - Cho phép mọi origin (tạm thời)
// ========================
app.use(cors({
...
// ========================
// Session - Quan trọng cho đăng nhập
// ========================
app.use(session({
    secret: 'evokey_super_secret_key_2024',
    resave: false,
    saveUninitialized: false,
    cookie: {
        secure: false,          // Để false vì Render dùng HTTPS nhưng chưa cần
        httpOnly: true,
